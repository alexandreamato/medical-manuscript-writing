...
| Funnel plot | Meta-analyses; interpretable and testable with 10 or more studies (Cochrane Handbook 13.3.4.4) | R: `metafor`, `meta` | [Funnel plot](#funnel-plot) |
...
For small-study effects (of which publication bias is one cause). Asymmetry tests need 10 or more studies (Cochrane Handbook version 6.5, section 13.3.4.4); with fewer, a plot may be shown but only descriptively. With fewer studies, assess missing evidence in other ways (registries, protocol-publication comparison, ROB-ME): `references/systematic-review.md` (7e).
