...
[First M. Last]^1^, [First M. Last]^2^, [First M. Last]^3^

1. [Affiliation, City, Country]. ORCID: [xxxx-xxxx-xxxx-xxxx]
2. [Affiliation, City, Country]. ORCID: [xxxx-xxxx-xxxx-xxxx]
3. [Affiliation, City, Country]. ORCID: [xxxx-xxxx-xxxx-xxxx]

**Corresponding author:** [First M. Last], [Address], [Email], [Phone]
...
**Methods.** [Design: e.g., "multicenter, double-blind, placebo-controlled, parallel-group randomized trial"]. [Setting and period]. [Eligibility: adults aged X with condition Y]. [Intervention vs. comparator: drug, dose, route, schedule, duration]. [Primary outcome at timepoint]. [Analysis population: intention-to-treat].

**Results.** [Of N screened, N were randomized between dates]. [The primary outcome occurred in n/N (%) of the [intervention] group vs. n/N (%) of the [comparator] group: HR/RR/OR (95% CI), p value]. [Key safety result.]

**Conclusions.** [One sentence with effect direction, scope (population), and time horizon. Use causal language calibrated to the design: "reduced", "did not reduce".]

**Trial registration.** [NCT00000000].
...
[Place the result in the context of existing trials and meta-analyses; explain agreements and disagreements with methodological reasons.]
...
[Among [population], [intervention] reduced [outcome] compared with [comparator] over [duration]. The take-home sentence should match the abstract Conclusion exactly.]

---

## Acknowledgments

[Substantial contributions not qualifying for ICMJE authorship; acknowledge by name with role described.]
...
[State any use of AI tools in writing or analysis, with tool name, version, and purpose. The authors take full responsibility for the manuscript.]

---

## References

[Vancouver-numbered, in order of first appearance. Manage with Zotero/EndNote/Mendeley using the journal's CSL style. See references/citation-styles.md and references/manuscript-conventions.md.]
...
**Table 1.** Baseline characteristics of study participants. [Footnote defining abbreviations and noting that no p values are reported per CONSORT.]
...
- Supplementary File 5. [Analysis code / synthetic example dataset].

---

<!-- Pre-submission checklist (delete before submitting):
     [ ] Numbers in Abstract match Results exactly
     [ ] Causal verbs match design (RCT can say "reduced")
