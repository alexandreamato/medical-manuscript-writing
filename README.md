...
**Version:** 1.8.1 (see [`CHANGELOG.md`](CHANGELOG.md))
...
> Amato ACM. Medical Manuscript Writing: Claude Skill [Internet]. Version 1.8.1. 2026. Available from: https://github.com/alexandreamato/medical-manuscript-writing
